...
export const GET_TOP_ARTISTS_SUCCESS = "GET_TOP_ARTISTS_SUCCES";
export const GET_TOP_TRACKS_SUCCESS = "GET_TOP_TRACKS_SUCCES";
...
export function tracksRequest() {
	return (dispatch) => {
		...
		(async function(){
			...
			let responseTracks = await fetch("http://ws.audioscrobbler.com/2.0/?method=chart.getTopTracks&limit=10" +
				"&api_key=e9fcdc63353cd735a0d4ae4cbf86ab6a&format=json"
			);
